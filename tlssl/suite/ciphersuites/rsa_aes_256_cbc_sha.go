...
func (x *x0x0035) Cipher(dst []byte, src []byte, ctx *suite.SuiteContext) ([]byte, error) {
...
func (x *x0x0035) ServerKX(data *kx.KXData) (*kx.KXParams, error) {
	return nil, nil
}

func (x *x0x0035) basicCheck(ctx *suite.SuiteContext) error {
