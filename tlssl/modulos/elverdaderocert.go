...
func (p *pki) setSignAlgoSupport() {
	...
	case *rsa.PublicKey:
		// RSA PKCS1
		p.saSupport[_RSA_PKCS1_SHA256] = true
		p.saSupport[_RSA_PKCS1_SHA384] = true
		p.saSupport[_RSA_PKCS1_SHA512] = true

		// RSA-PSS
		if pub.Size() >= 256 {
			p.saSupport[_RSA_PSS_RSAE_SHA256] = true
			p.saSupport[_RSA_PSS_RSAE_SHA384] = true
			p.saSupport[_RSA_PSS_RSAE_SHA512] = true
		}
	}
}
